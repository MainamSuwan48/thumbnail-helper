...
export function CoverToolbar({ canvasRef }) {
    const { canvasSize, setCanvasSize, fillCount, setFillCount, fillPool, mainImage, setMainImage, clearFillPool, shuffle, artistOverlay, updateArtistOverlay, } = useCoverStore();
